...
function Tasks(){
    ...
    return(
        <div className='outfit-500 relative  bg-gray-50'>
            ...
            <div className='flex flex-col gap-9 bg-gray-50 min-h-screen px-30 py-8'>
                <Header pageTitle="My Tasks"/>
                <div className='flex justify-between items-center flex-nowrap border-b border-gray-400 pb-3'>
